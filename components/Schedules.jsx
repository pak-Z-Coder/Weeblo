...
const Schedules = () => {
    ...
    const getAnimes = async () => {
        await getScheduledAnimes().then((res) => setAnimes(res));
        ...
        <div>
            ...
            <Carousel className="w-[95%] sm:w-[90%] mx-auto "
                ...
                <CarouselContent className="">
                    {animes && selectedDay && animes[selectedDay].map((anime) =>
                    ...
                    {animes && selectedDay && animes[selectedDay].length == 0 &&
                        <p className='mx-auto opacity-85 text-sm'>No schedules for {selectedDay}</p>
                    }
                </CarouselContent >
                <CarouselPrevious />
                <CarouselNext />
