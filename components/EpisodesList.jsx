...
const EpisodesList = ({ episodes, currentEp, animeId }) => {
    ...
    return (
        <div className={cn("mb-4 px-2 flex flex-col z-0 w-auto", openEps && "h-[47vh] md:h-[90vh] overflow-y-scroll no-scrollbar", !openEps && "h-10 lg:right-[5rem] lg:top-1 lg:outline rounded-lg outline-secondary lg:absolute lg:w-48 lg:opacity-40 lg:hover:opacity-90")}>
